// src/lib.rs
/*
 * Core library for AssetOptimizer
 */
...
#[derive(Debug)]
pub struct AssetOptimizerProcessor {
    verbose: bool,
    processed_count: usize,
}

impl AssetOptimizerProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting AssetOptimizer processing");
    
    let mut processor = AssetOptimizerProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = AssetOptimizerProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = AssetOptimizerProcessor::new(false);
